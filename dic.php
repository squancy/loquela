...
<body>
  <div class="outer">
    <div class="middle">
      ...
      <div class="btnCollect add">
        <textarea placeholder="Words you want to learn" class="inputWords hide" id="txtArea">
        </textarea>
        <button class="greyBtn hide" id="submitBtn">Submit</button>
      </div>
      <p class="info hide" id="infoText">
        Note: accepted format is foreign word<sub>1</sub>#word<sub>1</sub>, ... ,foreign word
        <sub>n</sub>#word<sub>n</sub>
      </p>
